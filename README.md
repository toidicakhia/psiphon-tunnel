[![CI](https://github.com/toidicakhia/psiphon-tunnel/actions/workflows/tests.yml/badge.svg)](https://github.com/toidicakhia/psiphon-tunnel/actions/workflows/tests.yml) [![Coverage Status](https://coveralls.io/repos/github/Psiphon-Labs/psiphon-tunnel-core/badge.svg?branch=master)](https://coveralls.io/github/Psiphon-Labs/psiphon-tunnel-core?branch=master)
...
- https://github.com/toidicakhia/psiphon-tunnel-binaries
- https://github.com/toidicakhia/psiphon-tunnel/releases, for libraries

For these instructions, use:
- [psiphond](https://github.com/toidicakhia/psiphon-tunnel-binaries/blob/master/psiphond/psiphond)
- [ConsoleClient](https://github.com/toidicakhia/psiphon-tunnel-binaries/blob/master/linux/psiphon-tunnel-core-x86_64)
...
The github.com/toidicakhia/psiphon-tunnel Go module may be imported into
...
```
% go get github.com/toidicakhia/psiphon-tunnel@staging-client
go: added github.com/toidicakhia/psiphon-tunnel v1.0.11-0.20240424194431-3612a5a6fb4c
```
