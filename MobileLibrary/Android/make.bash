...
if [ ! -f make.bash ]; then
  echo "make.bash must be run from $GOPATH/src/github.com/toidicakhia/psiphon-tunnel/MobileLibrary/Android"
  exit 1
fi
...
BUILDREPO="https://github.com/toidicakhia/psiphon-tunnel.git"
...
gomobile bind -v -x -target=android/arm,android/arm64,android/386,android/amd64 -tags="${BUILD_TAGS}" -ldflags="$LDFLAGS" github.com/toidicakhia/psiphon-tunnel/MobileLibrary/psi
if [ $? != 0 ]; then
