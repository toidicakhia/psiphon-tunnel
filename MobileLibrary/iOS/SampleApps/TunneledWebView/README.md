...
This app tunnels WKWebView traffic by proxying requests through the local Psiphon proxies created by [PsiphonTunnel](https://github.com/toidicakhia/psiphon-tunnel/tree/master/MobileLibrary/iOS/PsiphonTunnel).
...
[PsiphonTunnel's](https://github.com/toidicakhia/psiphon-tunnel/tree/master/MobileLibrary/iOS/PsiphonTunnel/PsiphonTunnel)
HTTP Proxy also offers a ["URL proxy (reverse proxy)"](https://github.com/toidicakhia/psiphon-tunnel/blob/631099d086c7c554a590b0cb76766be6dce94ef9/psiphon/httpProxy.go#L45-L70) 
...
*Requests to localhost (`127.0.0.1`) should be [excluded from being proxied](https://github.com/toidicakhia/psiphon-tunnel/blob/master/MobileLibrary/iOS/SampleApps/TunneledWebView/External/JiveAuthenticatingHTTPProtocol/JAHPAuthenticatingHTTPProtocol.m#L283-L287) so the system does not attempt to proxy loading the rewritten URLs. They will be correctly proxied through PsiphonTunnel's reverse proxy.*
