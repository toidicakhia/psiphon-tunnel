...
import (
	...
	"github.com/toidicakhia/psiphon-tunnel/psiphon/common/resolver"
...
type Config struct {
	...
	// https://github.com/toidicakhia/psiphon-tunnel/tree/master/psiphon/upstreamproxy
...
func (n *loggingNetworkIDGetter) GetNetworkID() string {
	...
	// See: https://godoc.org/github.com/toidicakhia/psiphon-tunnel/psiphon#NetworkIDGetter
