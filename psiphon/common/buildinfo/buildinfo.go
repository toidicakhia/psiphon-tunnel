...
import (
	...
	"github.com/toidicakhia/psiphon-tunnel/psiphon/common/values"
)
...
*/
// -X github.com/toidicakhia/psiphon-tunnel/psiphon/common/buildinfo.buildDate=`date --iso-8601=seconds`
var buildDate string

// -X github.com/toidicakhia/psiphon-tunnel/psiphon/common/buildinfo.buildRepo=`git config --get remote.origin.url`
var buildRepo string

// -X github.com/toidicakhia/psiphon-tunnel/psiphon/common/buildinfo.buildRev=`git rev-parse --short HEAD`
var buildRev string

// -X github.com/toidicakhia/psiphon-tunnel/psiphon/common/buildinfo.goVersion=`go version | perl -ne '/go version (.*?) / && print $1'`
